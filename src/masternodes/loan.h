...
inline CInterestRateV3 ConvertInterestRateToV3(const CInterestRateV2& rate2)
{
    ...
    rate3.interestPerBlock = {rate2.interestPerBlock};
...
public:
    ...
    void DeleteInterestDirect(const CVaultId& vaultId, DCT_ID id, uint32_t height);
    ...
    Res ReduceInterest(const uint32_t height, const CVaultId& vaultId, const std::string& loanSchemeID, const DCT_ID id, const CAmount loanDecreased, const CAmount interestDecreased);
    void ResetInterestToZero(const uint32_t height, const CVaultId& vaultId, const std::string& loanSchemeID, const DCT_ID id);
